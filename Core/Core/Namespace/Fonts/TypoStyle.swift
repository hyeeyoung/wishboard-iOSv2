...
public struct LabelDescription {
    public let singleLineHeight: CGFloat
    public let multiLineHeight: CGFloat
}
...
extension TypoStyle {
    public var font: UIFont {
        ...
        return UIFont.systemFont(ofSize: fontDescription.size, weight: .medium)
    }
}

extension UILabel {
    
    public func setTypoStyleWithSingleLine(typoStyle: TypoStyle) {
    ...
    public func setTypoStyleWithMultiLine(typoStyle: TypoStyle) {
