...
public protocol AuthRepositoryInterface {
    ...
    func requestRefreshToken(accessToken: String, refreshToken: String) async throws -> LoginResponse
...
public final class AuthRepository: AuthRepositoryInterface {
    ...
    public func requestRefreshToken(accessToken: String, refreshToken: String) async throws -> LoginResponse {
        return try await AuthManager.shared.requestRefreshToken(accessToken: accessToken, refreshToken: refreshToken)
    }
